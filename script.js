document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      if (value !== '') {
        ...
        if (maxLength && value.length > parseInt(maxLength, 10)) {
          showError(field, label + ' must be no more than ' + maxLength + ' characters.');
          return false;
        }
      }
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      // Dispatch custom event for further handling
      contactForm.dispatchEvent(new CustomEvent('formValidated', {
        bubbles: true,
        detail: { form: contactForm }
      }));

      // Simulate async – re-enable after delay if no external handler takes over
      setTimeout(function () {
  ...
  const SELECTOR = '.animate-on-scroll, [data-animate]';
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "🌸Jasmina_יסמין🌸 משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '1ae196a1-13c5-463d-b750-f6cdd0b86a67',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '1ae196a1-13c5-463d-b750-f6cdd0b86a67';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '1ae196a1-13c5-463d-b750-f6cdd0b86a67';
